// Package types -- педоставляет интерфейс виджета
package types
...
type IWidget interface {
	...
	SetScale(scale int)
	// Align -- возвращает направление заголовка в виджете
	Align() AAlign
	SetAlign(align AAlign)
